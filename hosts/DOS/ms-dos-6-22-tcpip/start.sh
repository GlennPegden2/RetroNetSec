...
qemu-system-x86_64 -m 16 -cpu 486 -net none  -device ne2k_isa,irq=3,iobase=0x300,netdev=lan,mac=52:54:00:AB:AA:03 -hda /root/ms-dos-6-22-tcpip.img   -netdev vde,id=lan,sock=/tmp/sw1 -parallel none -vnc :0 
